...
- **Tailored to the couple** — the lead basket **"Für Cornelius & Lisa"** and 8 items are matched to their real tastes (Franconian Keller & Schlenkerla smoked beer, döner-style Anatolian paprika paste, a home-sushi pantry, grill bratwurst, a culinary hemp wink) drawn from years of chat history — and deliberately skips harsh schnaps and stodgy desserts, which the chat shows they dislike.
...
- **9 suggested hampers** (**Für Cornelius & Lisa**, Ur-Berliner, Luxus, Weltreise, Handwerk, Klein & fein, Vorratskorb, Apéro-Brett, Berliner Hausbar) — each with a rationale for *why* the combination is interesting. Load one, then freely recombine.
